...
-- KukaDirectDynamics 10 trajectories from Kuka LWR iowa -- BaxterDirectDynamics 10 trajectories from Rethink Baxter robots
...
INPUTS: joint positions velocities and accelerations X_train: training inputs X_test: testing inputs

Outputs: joint torques Y_train: training outputs Y_test: testing outputs